...
/**
 * Admin settings for local_stackanalytics, merging both source
...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configtext(
        'local_stackanalytics/computetimelimit',
        get_string('computetimelimit', 'local_stackanalytics'),
        get_string('computetimelimit_desc', 'local_stackanalytics'),
        120,
        PARAM_INT
    ));
    ...
    $settings->add(new admin_setting_configtext(
        ...
        \local_stackanalytics\stack\analytics\target\question_needs_review::DEFAULT_PASSRATE_THRESHOLD,
        PARAM_FLOAT
    ));
    ...
    $settings->add(new admin_setting_configtext(
        ...
        \local_stackanalytics\stack\diagnostics\bloated_tree_report::LOW_TRAFFIC_FLOOR,
        PARAM_INT
    ));
    ...
    $settings->add(new admin_setting_configtext(
        ...
        \local_stackanalytics\stack\analytics\indicator\help_seeking_gap::LOOKBACK_SECONDS,
        PARAM_INT
    ));
}
