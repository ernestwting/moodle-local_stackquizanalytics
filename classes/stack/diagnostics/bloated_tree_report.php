...
namespace local_stackquizanalytics\stack\diagnostics;
...
class bloated_tree_report {
     ...
     * local_stackquizanalytics/lowtrafficfloor admin setting (Phase 6) is unset.
     */
    ...
    public static function get_low_traffic_floor(): int {
        $configured = get_config('local_stackquizanalytics', 'lowtrafficfloor');
