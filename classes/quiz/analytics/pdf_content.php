...
class pdf_content {
    ...
    public static function build_question_content(
        ...
        if (empty($selectedids)) {
            return [
                'title' => get_string('pdftitlequestion', 'local_stackquizanalytics', $quizname),
                'subtitle' => '',
                'sections' => [],
            ];
        }
        ...
        foreach ($selectedids as $id) {
            if ($id === 'summary') {
                ...
                $sections[] = [
                    'title' => get_string('pdfsectionsummary', 'local_stackquizanalytics'),
                    'caption' => get_string('pdfsectionsummarycaption', 'local_stackquizanalytics'),
                ...
                if (!empty($rows)) {
                    ...
                    $table = [
                        'columns' => array_merge(
                            [get_string('selectquestion', 'local_stackquizanalytics')],
                ...
                $sections[] = [
                    'title' => get_string('pdfsectionquestiondetails', 'local_stackquizanalytics'),
                    'caption' => get_string('pdfsectionquestiondetailscaption', 'local_stackquizanalytics'),
                    'table' => $table,
                    'charts' => [],
                ];
    ...
    public static function build_solutionprocess_content(
        ...
        if (empty($selectedids)) {
            return [
                'title' => get_string('pdftitlesolutionprocess', 'local_stackquizanalytics', $quizname),
                'subtitle' => '',
                'sections' => [],
            ];
        }
        ...
        return [
            'title' => get_string('pdftitlesolutionprocess', 'local_stackquizanalytics', $quizname),
            'subtitle' => get_string('pdfsolutionprocesssubtitle', 'local_stackquizanalytics', (object) [
                'question' => $question,
    ...
    public static function build_quiz_content(
        ...
        if (empty($selectedids)) {
            return [
                'title' => get_string('pdftitlequiz', 'local_stackquizanalytics', $coursename),
                'subtitle' => '',
                'sections' => [],
            ];
        }
        ...
        return [
            'title' => get_string('pdftitlequiz', 'local_stackquizanalytics', $coursename),
            'subtitle' => get_string('pdfquizsubtitle', 'local_stackquizanalytics'),
            'sections' => $sections,
        ];
    }
